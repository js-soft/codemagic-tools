...
import { TeamsMessaging } from "./teams/teams-messaging";


const args = require("yargs").usage("jscm command")
    .command( 'teams','This command is used to send a teams message via a passed webhook',
    (args: any) => {
